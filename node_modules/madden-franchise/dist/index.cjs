...
const slotsLookup = JSON.parse(
    fs.readFileSync(
        path.join(__dirname$4, '../data/lookup-files/slotsLookup.json'),
        'utf8'
    )
);
const fieldLookup = JSON.parse(
    fs.readFileSync(
        path.join(__dirname$4, '../data/lookup-files/fieldLookup.json'),
        'utf8'
    )
);
const enumLookup = JSON.parse(
    fs.readFileSync(
        path.join(__dirname$4, '../data/lookup-files/enumLookup.json'),
        'utf8'
    )
);
